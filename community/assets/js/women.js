/**
 * Women's Empowerment Page JavaScript
 * Handles loading and displaying empowerment programs
 */

// Load empowerment programs from database
async function loadEmpowermentPrograms() {
    ...
    try {
        ...
        const response = await fetch('api/get-empowerment-programs.php');
        ...
        console.error('Error loading empowerment programs:', error);
        loadingState.style.display = 'none';
        noPrograms.style.display = 'block';
    }
}
    ...
    card.innerHTML = `
        <div class="program-image">
            <img src="assets/images/programs/${program.image}" 
                 ...
                 loading="lazy"
                 onerror="this.src='assets/images/programs/default-empowerment.jpg'">
        ...
        <div class="program-content">
            ...
            <div class="program-details">
                ...
                <div class="program-detail">
                    ...
                    <span>${program.beneficiaries} Women Beneficiaries</span>
                </div>
                ` : ''}
...
window.WomenEmpowerment = {
    loadEmpowermentPrograms,
    createProgramCard
};
