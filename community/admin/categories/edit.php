...
// Get category data
$category_query = "SELECT * FROM community_categories WHERE id = ?";
...
// Get usage count
$usage_query = "SELECT COUNT(*) as program_count FROM community_programs WHERE category = ?";
$usage_stmt = mysqli_prepare($conn, $usage_query);
mysqli_stmt_bind_param($usage_stmt, "s", $category['name']);
...
<head>
    ...
    <title>Edit Category - Community Admin</title>
            ...
            <div class="content-area">
                ...
                <div class="page-header">
                    <div class="page-header-content">
                        ...
                        <p>Update information for <?php echo htmlspecialchars($category['name']); ?></p>
                    </div>
                ...
                <?php if ($usage_count > 0): ?>
                    <div class="usage-warning">
                        ...
                        <div class="usage-warning-content">
                            <strong>Category in Use</strong>
                            This category is currently being used by <?php echo $usage_count; ?> program(s). 
                            Changing the name will affect how these programs are categorized.
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="form-card">
                    ...
                    <form action="handlers/update-handler.php" method="POST" class="category-form" id="categoryForm">
                        ...
                        <div class="form-section">
                            ...
                            <input type="hidden" id="icon" name="icon" value="<?php echo htmlspecialchars($category['icon']); ?>">
                            
                            <div class="icon-grid">
                                <?php foreach ($icon_options as $icon_class => $icon_name): ?>
                                    <div class="icon-option <?php echo $category['icon'] === $icon_class ? 'selected' : ''; ?>" 
                                         data-icon="<?php echo htmlspecialchars($icon_class); ?>">
                        ...
                        <div class="form-section">
                            ...
                            <input type="hidden" id="color" name="color" value="<?php echo htmlspecialchars($category['color']); ?>">
                            
                            <div class="color-grid">
                                <?php foreach ($color_options as $color_code => $color_name): ?>
                                    <div class="color-option <?php echo $category['color'] === $color_code ? 'selected' : ''; ?>" 
                                         data-color="<?php echo htmlspecialchars($color_code); ?>">
                            ...
                            <div class="preview-section">
                                <div class="preview-category">
                                    ...
                                    <div class="preview-content">
                                        <h5 id="previewName"><?php echo htmlspecialchars($category['name']); ?></h5>
                                        <p id="previewDescription"><?php echo htmlspecialchars($category['description'] ?: 'Category description will appear here'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
