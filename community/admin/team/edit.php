...
if (!$member_id) {
    header('Location: index.php?error=' . urlencode('Invalid team member ID.'));
    exit;
}

// Get member data
$member_query = "SELECT * FROM community_team WHERE id = ?";
...
<head>
    ...
    <title>Edit Team Member - Community Admin</title>
            ...
            <div class="content-area">
                ...
                <div class="page-header">
                    <div class="page-header-content">
                        ...
                        <p>Update information for <?php echo htmlspecialchars($member['name']); ?></p>
                    </div>
                ...
                <div class="form-card">
                    ...
                    <form action="handlers/update-handler.php" method="POST" enctype="multipart/form-data" class="team-form" id="teamForm">
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" name="title" required 
                                           value="<?php echo htmlspecialchars($member['title']); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="bio" name="bio" rows="4" 
                                              placeholder="Brief biography or description of the team member"><?php echo htmlspecialchars($member['bio']); ?></textarea>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="order_position" name="order_position" 
                                               value="<?php echo $member['order_position']; ?>" min="1">
                        ...
                        <div class="form-section">
                            ...
                            <div class="image-upload-container">
                                <div class="image-preview" id="imagePreview">
                                    <?php if ($member['image']): ?>
                                        <img src="../../assets/images/team/<?php echo htmlspecialchars($member['image']); ?>" 
                                             alt="Current image">
                                    <?php else: ?>
                                ...
                                <div class="image-upload-controls">
                                    ...
                                    <label for="image" class="btn btn-outline">
                                        ...
                                        <?php echo $member['image'] ? 'Change Image' : 'Choose Image'; ?>
                                    </label>
                                    <?php if ($member['image']): ?>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" id="instagram" name="instagram" 
                                           value="<?php echo htmlspecialchars($member['instagram']); ?>"
            ...
            if (removeImageBtn) {
                removeImageBtn.addEventListener('click', function() {
                    ...
                    if (!removeInput) {
                        ...
                        teamForm.appendChild(removeInput);
                    }
                    removeInput.value = '1';
                });
            }
