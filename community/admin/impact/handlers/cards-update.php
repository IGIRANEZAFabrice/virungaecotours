...
$ok = mysqli_query($conn, "UPDATE impact_cards SET title='$title_safe', description='$desc_safe' $image_clause WHERE id=$id AND page_id=$page_id");
header('Location: ../index.php?' . ($ok ? 'success=Card updated' : 'error=Update failed'));
exit;
