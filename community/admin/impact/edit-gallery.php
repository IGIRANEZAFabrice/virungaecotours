...
$id = (int)($_GET['id'] ?? 0);
if ($id <= 0) { header('Location: index.php?error=Invalid gallery id'); exit; }

$res = mysqli_query($conn, "SELECT id, page_id, title, description, image FROM impact_gallery WHERE id = $id");
$row = $res ? mysqli_fetch_assoc($res) : null;
if (!$row) { header('Location: index.php?error=Gallery item not found'); exit; }
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
    .admin-container { margin-left: 280px; }
	...
	<?php include '../includes/topbar.php'; ?>
		<main class="admin-main">
			<header class="page-header">
				<h1><i class="fas fa-images"></i> Edit Gallery Item</h1>
			</header>
			<section class="card">
				<div class="card-body">
					<form action="handlers/gallery-update.php" method="post" enctype="multipart/form-data" class="form-grid">
