...
<body>
    ...
    <section class="hero-section">
        <div class="hero-background">
            ...
            <img src="../images/farm/hero.jpg" alt="Farm and Cultural Heritage" class="hero-bg-img">
        </div>
        <div class="container">
        ...
        <div class="container">
            <div class="intro-content">
                ...
                <div class="intro-image">
                    <img src="../images/farm/1.jpg" alt="Community tourism activities" class="intro-img">
