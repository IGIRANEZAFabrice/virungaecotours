      ...
      <div class="dropdown-container">
        <div class="destination-group">
          <div class="nav-item-with-nested">
            <a href="./pages/gorilla.php" class="has-sub">COMMUNITY & LIVING VIRUNGA EXPERIENCES</a>
          ...
          <div class="nav-item-with-nested">
            <a href="./pages/museums.php" class="has-sub">VIRUNGA CULTURAL HERITAGE JOURNEYS</a>
            <div class="nested-dropdown">
              <div class="nested-dropdown-container">
          ...
          <div class="nav-item-with-nested">
            <a href="./pages/cycling.php" class="has-sub">VIRUNGA ADVENTURE EXPEDITIONS</a>
            <div class="nested-dropdown">
              <div class="nested-dropdown-container">
